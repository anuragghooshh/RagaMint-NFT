...
const getRarityColor = (score) => {
  ...
  if (score >= 75)
    return "bg-teal-500/20 text-teal-300 hover:bg-teal-500/30 border-teal-500/50";
  if (score >= 60)
    return "bg-yellow-500/20 text-yellow-300 hover:bg-yellow-500/30 border-yellow-500/50";
  if (score >= 40)
    return "bg-yellow-500/20 text-yellow-300 hover:bg-yellow-500/30 border-yellow-500/50";
